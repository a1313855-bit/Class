...
public class PorderDaoImpl implements PorderDao {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//查詢(名稱)
		//System.out.println(new PorderDaoImpl().select_by_name("Mr.A"));
		
		//查詢(金額區間)
		//System.out.println(new PorderDaoImpl().select_by_sum(300,600));
	...
	@Override
	public List<Porder> select_by_name(String name) {
	...
	@Override
	public List<Porder> select_by_sum(int start, int end) {
